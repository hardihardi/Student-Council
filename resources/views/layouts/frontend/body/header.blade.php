                            ...
                            <div class="mobile-footer px-20 py-20 border-top-light js-mobile-footer">
                                <div class="mobile-footer__number">
                                    ...
                                    <div class="text-17 fw-500 text-purple-1">
                                        <a href="tel:+6281286274675">+62 812-8627-4675</a>
                                    </div>
                                </div>

                                <div class="lh-2 mt-10">
                                    <div>Cikarang Pusat, Bekasi,
                                        <br> Jawa barat 17530, Indonesia.
                                    </div>
                                    <div>
                                        <a href="mailto:osis@smanda.sch.id">osis@smanda.sch.id</a>
                                    </div>
                                </div>
